...
if(!isset($_SESSION['logged_in']) && !in_array("Test-result", $url_arr)){
	...
	<div role="navigation" class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="home">Start New Test</a></li>
					<li><a href="https://www.facebook.com/groups/smartteenshome">Join Smart Teens Home</a></li>
					<li><a href="https://docs.google.com/forms/d/e/1FAIpQLSc21clT3x7UMUu-1X9TtftUAAga7Lkr_3ortsfk__2H5lHcmw/viewform?c=0&w=1">Register For Smart Teens Camp</a></li>
				</ul>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="logout"> <span class="glyphicon glyphicon-log-out"></span>  Logout</a></li>
           <li><a HREF="javascript:window.print()"> <span class="glyphicon glyphicon-print"></span>  Print</a></li>
