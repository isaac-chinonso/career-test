...
class Cl_User
{
	...
	public function registration( array $data )
	{
		if( !empty( $data ) ){
			...
			$career_test = mysqli_real_escape_string( $this->_con, $trimmed_data['career_test'] );
			$school_attended = mysqli_real_escape_string( $this->_con, $trimmed_data['school_attended'] );
			...
			if((!$name) || (!$email) || (!$password) || (!$cpassword) || (!$phone) || (!$age) || (!$career_test) || (!$school_attended) ) {
			...
			$query = "INSERT INTO users (id, name, email, password, phone, age, career_test, school_attended, created) VALUES (NULL, '$name', '$email',  '$password', '$phone', '$age', '$career_test', '$school_attended', CURRENT_TIMESTAMP)";
